  ...
  return (
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl flex-col gap-12">
          <nav className="glass-nav flex items-center justify-between gap-4 px-4 py-3">
            <a href="#top" className="flex items-center gap-3 font-semibold" aria-label="Ketan Patil portfolio home">
              <img src={iconLogo} alt="Ketan Patil KP logo" width={40} height={40} className="h-10 w-10 rounded-lg object-contain shadow-neon" />
            ...
            <a className="neon-button" href="mailto:patilketan1303@gmail.com?subject=Job%20Opportunity%20Inquiry&body=Hi%20Ketan,%0D%0A%0D%0AI%20came%20across%20your%20portfolio%20and%20would%20like%20to%20discuss%20a%20job%20opportunity%20with%20you.%0D%0A%0D%0ADetails:%0D%0A">
            ...
            >
              <div>
                ...
                <motion.div variants={fadeUp} className="mt-8 flex flex-col gap-3 sm:flex-row">
                  ...
                  <a className="ghost-button" href="mailto:patilketan1303@gmail.com?subject=Job%20Opportunity%20Inquiry&body=Hi%20Ketan,%0D%0A%0D%0AI%20came%20across%20your%20portfolio%20and%20would%20like%20to%20discuss%20a%20job%20opportunity%20with%20you.%0D%0A%0D%0ADetails:%0D%0A">
                ...
                <motion.div variants={fadeUp} className="mt-8 grid gap-3 text-sm text-muted-foreground sm:grid-cols-2">
                  ...
                  <a className="contact-pill" href="mailto:patilketan1303@gmail.com?subject=Job%20Opportunity%20Inquiry&body=Hi%20Ketan,%0D%0A%0D%0AI%20came%20across%20your%20portfolio%20and%20would%20like%20to%20discuss%20a%20job%20opportunity%20with%20you.%0D%0A%0D%0ADetails:%0D%0A"><Mail size={16} /> <span suppressHydrationWarning>patilketan1303@gmail.com</span></a>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
        <a href="https://wa.me/917517305365?text=Hi%20Ketan,%20I%20am%20reaching%20out%20regarding%20a%20job%20opportunity" target="_blank" rel="noreferrer" className="flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-110" aria-label="WhatsApp">
        ...
        <a href="tel:+917517305365" className="flex h-12 w-12 items-center justify-center rounded-full bg-accent text-accent-foreground shadow-lg transition-transform hover:scale-110" aria-label="Call">
          <Phone size={22} />
        </a>
        <a href="mailto:patilketan1303@gmail.com?subject=Project%20Inquiry%20-%20Let's%20Work%20Together&body=Hi%20Ketan,%0D%0A%0D%0AI%20am%20interested%20in%20discussing%20a%20project%20with%20you.%0D%0A%0D%0ADetails:%0D%0A" className="flex h-12 w-12 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg transition-transform hover:scale-110" aria-label="Email">
          <Mail size={22} />
        </a>
      </div>
    </main>
